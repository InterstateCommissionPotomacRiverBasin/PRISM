...
@author: aseck
PRISM data analysis
extract Prism precip by county from raster files
"""
...
textdir = "D:/2019_demandstudy/PRISM_raster/precip/monthly/"
maindir = "D:/2019_demandstudy/"
#os.chdir(savedir)

counties_file1 = maindir + "md_va_reg.txt"
counties_file2 = maindir + "md_va_regions.csv"
outfile = maindir + "md_va_monthly_precip2.csv"
...
counties_list = df_counties['OBJECTID']
for county in counties_list:
    ...
    for year in range(startyear, endyear+1): #loop through years
        ...
        for i in range(1,9):
            textfile = textdir + str(year) + "/prism_ppt_stable_4kmm3_"+ str(year) + str(i).zfill(2)  + "_bil.txt"
            print textfile
